...
module mkcsr(CLK,
  ...
  reg [31 : 0] y_avValue_snd_fst__h658;
  wire [31 : 0] writecsrdata__h613, writecsrdata__h614, x__h626;
  ...
  always@(system_instruction_funct3 or
	  writecsrdata__h614 or system_instruction_op1 or writecsrdata__h613)
  begin
    case (system_instruction_funct3[1:0])
      2'd1: csrfile_write_csr_word = system_instruction_op1;
      2'd2: csrfile_write_csr_word = writecsrdata__h613;
      default: csrfile_write_csr_word = writecsrdata__h614;
    endcase
  end
  ...
  // remaining internal signals
  assign writecsrdata__h613 = system_instruction_op1 | csrfile_read_csr ;
  assign writecsrdata__h614 = x__h626 & csrfile_read_csr ;
  assign x__h626 = ~system_instruction_op1 ;
  always@(system_instruction_csr_address or csrfile_upd_on_ret)
  begin
    case (system_instruction_csr_address[11:8])
      4'h0, 4'h3: y_avValue_snd_fst__h658 = csrfile_upd_on_ret;
      default: y_avValue_snd_fst__h658 = 32'd0;
    endcase
  end
endmodule  // mkcsr
