...
module mkalu(CLK,
  ...
  wire [73 : 0] fn_alu___d12;

  // actionvalue method inputs
  assign inputs =
	     (inputs_inst_type == 4'd8) ? muldiv_get_inputs : fn_alu___d12 ;
  assign RDY_inputs = muldiv_RDY_get_inputs ;
  assign CAN_FIRE_inputs = muldiv_RDY_get_inputs ;
  ...
  mkmuldiv muldiv(.CLK(CLK),
		  ...
		  .get_inputs_in1(muldiv_get_inputs_in1),
		  .get_inputs_in2(muldiv_get_inputs_in2),
		  .EN_get_inputs(muldiv_EN_get_inputs),
		  .EN_delayed_output(muldiv_EN_delayed_output),
		  .EN_flush(muldiv_EN_flush),
		  .get_inputs(muldiv_get_inputs),
		  .RDY_get_inputs(muldiv_RDY_get_inputs),
  ...
  assign muldiv_get_inputs_in1 = inputs_op1 ;
  assign muldiv_get_inputs_in2 = inputs_op2 ;
